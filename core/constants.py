# core/constants.py
# all magic numbers, colors, presets in one place — nothing computed here
...
# difficulty — smaller target + faster fade = higher attentional demand
DIFFICULTY_LEVELS = {
...
DIFF_COLORS = {1: GREEN, 2: CYAN, 3: YELLOW, 4: PINK, 5: RED}

HIT_POINTS = {"Perfect": 300, "Great": 200, "Good": 100}
HP_GAIN    = {"Perfect": 4.0, "Great": 2.0, "Good": 1.0}
HP_LOSS_MISS = 12.0

# dda / attention thresholds
STABILITY_VARIANCE_CAP = 500.0
STABILITY_GOOD         = 0.7
STABILITY_WARN         = 0.4
IMPULSIVITY_VAR_THRESH = 120
DDA_WINDOW             = 3
SPAWN_INTERVAL         = 2.2